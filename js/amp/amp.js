...
export function gotStream(audioContext) {
    ...
    var audioInput = convertToMono(audioContext, input);
...
function convertToMono(audioContext, input) {
...
function Amp(context) {
    ...
    presenceFilter = context.createBiquadFilter();
    ...
    reverb = new Convolver(context, Impulses.reverbImpulses, 'reverbImpulses');
    cabinetSim = new Convolver(context, Impulses.cabinetImpulses, 'cabinetImpulses');
  ...
  function changeBassFilterValue(sliderVal) {
    ...
    return {
        ...
        toggleGuitarInput: toggleGuitarInput
    };
}
